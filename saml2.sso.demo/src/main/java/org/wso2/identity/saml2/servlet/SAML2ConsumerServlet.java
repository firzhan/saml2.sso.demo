...
import org.wso2.identity.saml2.manager.SamlConsumerManager;
...
public class SAML2ConsumerServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String responseMessage = request.getParameter(SAML2Constants.SAML_RESPONSE_ATTRIBUTE);
		
		if (responseMessage != null) { /* response from the identity provider */

			request.getSession().setAttribute(SAML2Constants.SAML_RESPONSE_ATTRIBUTE, responseMessage);//Already encoded
